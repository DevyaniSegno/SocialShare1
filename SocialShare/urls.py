...
urlpatterns = [
    ...
    path('fb_grp_post/', views.fb_grp_post, name='fb_grp_post'),
    path('li_com/', views.li_com, name='li_com'),
    path('li_post/', views.li_post, name='li_post'),
    path('li_grp_post/', views.li_grp_post, name='li_grp_post'),
    ...
    path('quora_post_spaces/', views.quora_post_spaces, name='quora_post_spaces'),
